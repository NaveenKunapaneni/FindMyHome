...
![alt text](https://github.com/NaveenKunapaneni/FindMyHome/blob/main/Images/LoginPage.png)

### Register:

The registration page provides an option to the user to register by providing basic personal information.

![alt text](https://github.com/NaveenKunapaneni/FindMyHome/blob/main/Images/Register.png)
...
![alt text](https://github.com/NaveenKunapaneni/FindMyHome/blob/main/Images/Preferences.png)
...
![alt text](https://github.com/NaveenKunapaneni/FindMyHome/blob/main/Images/AllListings.png)
...
![alt text](https://github.com/NaveenKunapaneni/FindMyHome/blob/main/Images/Profilepage.png)
...
![alt text](https://github.com/NaveenKunapaneni/FindMyHome/blob/main/Images/Groups.png)

### Create Listings

From the profile page the user can create a listing and upload basic details along with the pictures.

![alt text](https://github.com/NaveenKunapaneni/FindMyHome/blob/main/Images/CreateListing.png)
